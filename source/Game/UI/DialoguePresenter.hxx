...
public:
    ...
    void SetNarrativeRuntime(NarrativeRuntime* Runtime) { m_Narrative = Runtime; }
    NarrativeRuntime* GetNarrativeRuntime() const { return m_Narrative; }
...
private:
    ...
    void NotifyLineEntered();

    VisualNovelConfig m_Config;
    DialogueTree* m_Tree{nullptr};
    NarrativeRuntime* m_Narrative{nullptr};
