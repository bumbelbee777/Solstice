...
struct SOLSTICE_API FluidSolverTuning {
    ...
    bool parallelAnisotropicLinearSolve = false;
    bool usePressureMultigrid = true;
    int pressureMultigridLevels = 4;
    int pressureMultigridPreSmooth = 2;
    int pressureMultigridPostSmooth = 2;
    int pressureMultigridCoarseSmooth = 18;
...
private:
    ...
    AlignedFloatScratchBuffer temporalReprojectionScratch;
    std::vector<std::complex<float>> spectralScratch;
